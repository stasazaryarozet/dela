...
def setup_azarya_whatsapp():
    """Интерактивная настройка WhatsApp для Azarya"""
    print("=" * 80)
    print("НАСТРОЙКА WHATSAPP ДЛЯ AZARYA")
    print("=" * 80)
    print()
    ...
    credentials_path = credentials_dir / 'azarya_credentials.json'
    ...
    print("2. Используйте WhatsAppMultiUserGate(user='azarya') для работы")
    print()
    
    return True

if __name__ == '__main__':
    success = setup_azarya_whatsapp()
